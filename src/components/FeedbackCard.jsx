...
const FeedbackCard = ({content, name, title, img}) => 
 (
    ...
    <img src={quotes} alt="double_quotes" className="w-[43px] h-[27px] object-contain" />
    <p className="font-poppins font-normal text-[18px] leading-[32px] text-gray-700 my-10">{content}</p>

    <div className='flex flex-row'>
      <img src={img} alt={name} classname ="w-[48px] h-[48px] rounded-full object-contain"/>
      <div className ="flex flex-col ml-4">
        <h4 className ="font-poppins font-semibold text-[20px] leading-[32px] text-gray-700 my-10">{name}</h4>
