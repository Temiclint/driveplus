...
(
  ...
  <div className="flex-1 flex flex-col ml-3">
    <h4 className="font-raleway font-semibold text-gray-700 text-[18px] leading-[23px] mb-1">
    {title}
   </h4>
    <p className="font-raleway font-normal text-dimWhite text-[16px] leading-[24px] mb-1">
      {content}
    </p>
   </div>
  </div>
